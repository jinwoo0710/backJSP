        ...
        <div class="container">
            <div class="header-content">
                ...
                <div class="header-actions">
                    ...
                    <div class="user-menu">
                        <%
                            String chatUserId = (String) session.getAttribute("userid");
                            if (chatUserId == null) {
                                chatUserId = (String) session.getAttribute("userID");
                            }
                            
                            if (chatUserId != null) {
                                out.println("<a href='../chat.jsp' class='icon-btn' title='채팅'>💬</a>");
                            } else {
                                out.println("<a href='login.jsp?msg=login_required' class='icon-btn' title='채팅을 사용하려면 로그인하세요'>💬</a>");
                            }
                        %>
                        <%
