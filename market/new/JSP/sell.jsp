    ...
    <div class="container">
        <div class="buy-page">
            ...
            <div class="content-layout">
	                ...
	                <button type="submit" class="logo-icon">🔍 필터 적용</button>
                ...
                <div class="main-content">
                    <div class="results-info">
                        <span id="resultCount">총 ${totalCount}개의 상품</span>
							...
							<div class="product-card" onclick="goToProduct(${dto.postid})">
							    <div class="product-image">
							        <c:if test="${not empty dto.image}">
							            <img src="../uploads/sellImages/${dto.image}" alt="${dto.title}">
							        </c:if>
							        <c:if test="${empty dto.image}">
							            <div style="width: 100%; height: 200px; display: flex; align-items: center; justify-content: center; background-color: #f3f4f6; color: #9ca3af; font-size: 48px;">📦</div>
							        </c:if>
							    ...
							    <div class="product-info">
							        ...
							        <p class="product-price"><fmt:formatNumber value="${dto.price}" pattern="#,###"/>원</p>
    ...
    <script>
        ...
        function renderProducts() {
            ...
            grid.innerHTML = filteredProducts.map(product => `
                <div class="product-card" onclick="goToProduct(${product.postid})">
                    <div class="product-image">
                        <% 
                            String image = (String) pageContext.findAttribute("dto");
                            if (image != null && !image.isEmpty()) {
                                String[] images = image.split(",");
                                String firstImage = images[0].trim();
                        %>
                            <img src="../uploads/sellImages/<%= firstImage %>" alt="${product.title}">
                        <% } else { %>
                            <div style="width: 100%; height: 200px; display: flex; align-items: center; justify-content: center; background-color: #f3f4f6; color: #9ca3af; font-size: 48px;">📦</div>
                        <% } %>
                        <button class="like-btn" onclick="toggleLike(event, this)">❤️</button>
        ...
        function goToProduct(postid) {
	    	window.location.href = 'sellpost.jsp?id=' + postid;
		}
