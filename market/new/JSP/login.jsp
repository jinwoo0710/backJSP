...
<body>
    <div class="container">
        <div class="login-container">
            ...
            <!-- 로그인 폼 -->
            <form action="loginPro.jsp" method="post" class="login-form" id="loginForm">
                <%
                ...
                %>
                    <div class="alert alert-warning" style="display: block; background-color: #ff9800; color: white; padding: 12px; border-radius: 8px; margin-bottom: 16px;">
                ...
                <%
                    ...
                    if ("1".equals(error)) {
                %>
                    <div class="alert alert-error" style="display: block; background-color: #fee2e2; color: #991b1b; border: 1px solid #fca5a5; padding: 12px; border-radius: 8px; margin-bottom: 16px;">
