        ...
        <form action="buymakePro.jsp" >
            ...
            <div class="section">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="title" name="title" class="form-input" placeholder="구매하고 싶은 상품을 입력하세요" maxlength="50" required>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="price-input">
                            <input type="number" id="budget" name="price" class="form-input" placeholder="0" min="1000" max="10000000" required>
                ...
                <div class="form-group">
                    ...
                    <div class="radio-group">
                        <div class="radio-item selected">
                            <input type="radio" id="normal" name="urgency" value="일반" checked>
                            <label for="normal">일반</label>
                        </div>
                        <div class="radio-item">
                            <input type="radio" id="urgent" name="urgency" value="급구">
            ...
            <div class="section">
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" class="form-input form-textarea" name="content" placeholder="원하는 상품의 상세 조건을 작성해주세요&#10;예: 색상, 용량, 상태, 구매 시기 등" maxlength="1000" required></textarea>
                    <div class="char-counter">
            ...
            <div class="section">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" id="location" name="location" class="form-input" value="서울시 강남구" placeholder="거래 희망 지역" required>
                ...
                <div class="form-group">
                    ...
                    <div class="checkbox-group">
                        <div class="checkbox-item">
                            <input type="checkbox" id="meetup" name="deal" value="직거래" checked>
                            <label for="meetup">직거래</label>
                        </div>
                        <div class="checkbox-item">
                            <input type="checkbox" id="delivery" name="deal" value="택배" checked>
            ...
            <div class="section">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="tel" id="phone" name="phone" class="form-input" value="010-1234-5678" placeholder="연락 가능한 번호">
                        <div class="form-hint">연락처는 판매자에게만 공개됩니다.</div>
                    </div>

                    <div class="form-group">
                        <label for="contactTime" class="form-label">연락 가능 시간</label>
                        <select id="contactTime" name="calltime" class="form-select">
                ...
                <div class="form-group">
                    ...
                    <div class="checkbox-group">
                        <div class="checkbox-item">
                            <input type="checkbox" id="chatContact" name="concat" value="채팅" checked>
                            <label for="chatContact">채팅</label>
                        </div>
                        <div class="checkbox-item">
                            <input type="checkbox" id="phoneContact" name="concat" value="전화">
                            <label for="phoneContact">전화</label>
                        </div>
                        <div class="checkbox-item">
                            <input type="checkbox" id="messageContact" name="concat" value="문자">
