...
<body>
	<nav class="navbar">
        <div class="navbar-container">
            <a href="index.jsp" class="navbar-logo">JUPJUP마켓</a>
            <div class="navbar-menu">
                <a href="buy.jsp" class="navbar-link">구매하기</a>
                <a href="sell.jsp" class="navbar-link">판매하기</a>
                <a href="community.jsp" class="navbar-link">커뮤니티</a>
            </div>
        </div>
    </nav>
    <div class="container">
            ...
            <div class="profile-header">
                <div class="profile-info">
                    ...
                    <div class="profile-details">
                        ...
                        <p class="profile-email"><%=  session.getAttribute("userid")%></p>
                    ...
                    <div class="profile-actions">
                       ...
                       <form action=logout.jsp method="post"><button class="btn btn-secondary" onclick="logout()">로그아웃</button></form>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        function editProfile() {
        	window.location.href = 'myfix.jsp';
        }
