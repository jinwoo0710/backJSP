...
<body>
    ...
    <header class="header">
        <div class="container">
            <div class="header-content">
                ...
                <!-- 네비게이션 -->
                <nav class="nav">
                    <a href="buy.jsp" class="active">구매하기</a>
    ...
    <script>
        ...
        const products = [
            {
                id: 1,
                title: "아이폰 14 Pro 128GB 딥퍼플 (배터리 100%)",
                price: 850000,
                location: "강남구",
                timeAgo: "2시간 전",
            ...
            {
                id: 5,
                title: "갤럭시 S23 Ultra 256GB 팬텀블랙",
                price: 750000,
                location: "강서구",
                timeAgo: "3일 전",
            ...
            {
                id: 6,
                title: "아이패드 프로 11인치 3세대 128GB WiFi",
                price: 650000,
                location: "노원구",
                timeAgo: "4일 전",
                    ...
                    <div class="product-image">
                        ...
                        <c:if test="${product.status != '판매중'}">
						  <span class="status-badge 
						    <c:out value='${product.status == "예약중" ? "reserved" : "sold"}'/>">
						    ${product.status}
						  </span>
						</c:if>
